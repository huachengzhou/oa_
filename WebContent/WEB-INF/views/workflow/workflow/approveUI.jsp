...
<!--显示表单内容-->
<div id=MainArea>
	<form:form action="#" method="post" name="approveName">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
                        <td>审批意见</td>
                        <td><textarea id="comment_Txt" name="comment" class="TextareaStyle" style="width: 500px;"></textarea></td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div id="InputDetailBar" style="float:none">
			...
			<input type="button" id="btn1" src="${pageContext.request.contextPath}/css/blue/images/button/agree.png"/>
			<input type="button" id="btn2" src="${pageContext.request.contextPath}/css/blue/images/button/disagree.png"/>
    ...
    <script type="text/javascript">
    	window.onload = function(){
    		...
    		var taskId = document.approveName.taskId.value;
    		var fid = document.approveName.fid.value;
    		btn1.onclick = function(){
    			var url = "${pageContext.request.contextPath}/approveData?taskId="+taskId+
    					"&fid=" + fid +"&commen="+comment_Txt +"&fag=1";
    			window.location.href = url;
    		};
    		btn2.onclick = function(){
    			var url = "${pageContext.request.contextPath}/approveData?taskId="+taskId+
    					"&fid=" + fid +"&commen="+comment_Txt +"&fag=2";
    			window.location.href = url;
    		};
    	};
